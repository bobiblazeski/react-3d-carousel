...
/***/ function(module, exports, __webpack_require__) {
	...
	/** @jsx React.DOM */var Carousel = __webpack_require__(2);
	var Ease = __webpack_require__(3);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Images = __webpack_require__(7);
	    ...
	    render: function () {
	        ...
	        return (
	            React.createElement("section", {className: "container"}, 
	                ...
	                React.createElement("div", {className: "prev", onClick: Util.partial(this.onMove, angle)}), 
	                React.createElement("div", {className: "next", onClick: Util.partial(this.onMove,-angle)})
	            )
	        );
	    }
	});
